...
import newRealseImg from "../assets/images/banner-8.jpg";
        ...
        <div className="  mx-2 rounded my-4 relative    transform transition-transform duration-300 ">
          ...
          <div className=" flex flex-col justify-between  p-4">
            ...
            <div className="flex items-center mt-2 justify-center">
              <button class="relative flex items-center justify-between w-36 h-10 cursor-pointer border-b-2 border-r-4  border-gray-800  rounded-lg bg-gray-100 shadow-lg overflow-hidden transition-transform duration-1000 ease-in-out transform hover:scale-105 active:translate-x-1 active:translate-y-1 group">
